...
public interface OrderInterface {
	...
	/**
	 * returns the beverage listed in the itemNo of the order, for example if itemNo
	 * is 0 this method will return the first beverage in the order Note: this
	 * method returns the shallow copy of the Beverage
	 * 
	 * @return the beverage listed in the itemNo of the order or null if there is no
	 *         item in the order
	 * 
	 */
